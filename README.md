...
<p>log2 fold-change ('<b>avg_log2FC</b>') indicating up-regulation (positive values) or down-regulation in cancer cells, along with adjusted p-values ('<b>p_val_adj</b>').</p>
