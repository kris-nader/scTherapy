...
<p>Here, we provide `T cells` as confident healthy cell cluster, given that `T cells` are considered as normal cells in AML [10.1016/j.cell.2019.01.031](https://doi.org/10.1016/j.cell.2019.01.031)</p>
